...
| **SCRM** | Social CRM | 社交渠道获客与私域运营（企微、社群、内容） | 零售、教培、本地生活、消费品牌 | 企微 SCRM、微盟、有赞、尘锋 |
...
下面按「学什么、管什么、和谁对接」展开说明。客户侧系统（CRM / SCRM）放在最前，再进入企业内部经营与执行类系统。

### 1. CRM：客户关系管理

**定位：** 面向「客户侧」的经营系统，把与客户相关的人、事、过程沉淀为可管理的数据，覆盖获客、转化、成交、服务与复购。

一句话：**CRM 管的是「客户从哪里来、怎么跟进、如何成交、成交后如何服务」**，而不是仓库里有多少货、财务怎么记账。

**为什么需要 CRM：**

- 销售过程若只靠 Excel / 聊天记录，线索容易丢失、跟进不可视、交接成本高
- 客户数据集中后，才能做分层运营、预测成交、复盘转化漏斗
- 营销、销售、客服共用同一客户视图，避免「一个客户多套档案」

**常见能力：**

| 阶段 | 能力举例 | 典型产出 |
| --- | --- | --- |
| 获客 | 线索采集、渠道归因、营销自动化 | 线索池、渠道 ROI |
| 转化 | 商机跟进、报价、合同、销售漏斗 | 商机阶段、赢单率 |
| 服务 | 工单、回访、知识库、NPS / CSAT | 工单闭环、满意度 |
| 运营 | 客户分层、会员、复购与续约策略 | RFM、生命周期价值 |

**两类常见形态：**

| 类型 | 侧重 | 典型场景 |
| --- | --- | --- |
| **ToB CRM** | 长周期销售、多人协作、商机与合同 | 软件、设备、企业服务销售 |
| **ToC CRM / 会员** | 高并发触达、会员等级、优惠与复购 | 电商、零售、连锁门店 |
...
- 先分清对象：线索（Lead）→ 客户 / 联系人（Account / Contact）→ 商机（Opportunity）
- 关注权限与组织：公海池、私海、团队协作、客户归属规则
- 和营销自动化、客服、SCRM 常有边界重叠，选型时先定「主数据以谁为准」

### 2. SCRM：社交化客户关系管理

**定位：** Social CRM，在传统 CRM 之上强化 **社交渠道与私域触达**——把微信生态、社群、内容平台、直播等互动行为纳入客户经营。

一句话：**CRM 更偏「客户档案与销售过程」；SCRM 更偏「在社交场景里持续连接、转化与运营客户」。**

国内语境下，SCRM 往往与 **企业微信、公众号、小程序、社群、私域流量** 强绑定，解决的是「流量贵、复购难、客户散落在聊天工具里」的问题。

**相对传统 CRM 多出来的能力：**

| 能力域 | 做什么 | 举例 |
| --- | --- | --- |
| 社交获客 | 把社交互动沉淀为可运营线索 | 活码、渠道活码、裂变海报、表单 |
| 私域连接 | 建立可持续触达的客户关系 | 企微加好友、标签、客户群 |
| 内容与互动 | 用内容推动认知与转化 | 朋友圈素材、群 SOP、小程序商城 |
| 社群运营 | 规模化管理群与社群转化 | 自动拉群、群公告、群任务 |
| 导购 / 员工赋能 | 让一线用社交工具卖货与服务 | 员工分销、会话存档、话术助手 |

**典型链路（以企微私域为例）：**

```text
公域投放 / 门店扫码 → 加企微好友 → 打标签与分群
→ 朋友圈 / 群发 / 社群培育 → 小程序下单或预约到店
→ 订单回写 CRM / 中台 → 售后与复购触达
```
...
| 对比项 | CRM | SCRM |
| --- | --- | --- |
| 核心对象 | 客户档案、商机、合同、工单 | 社交身份、会话、社群、内容互动 |
| 主战场 | 销售管理后台、呼叫中心、邮件 | 微信 / 社群 / 内容平台 / 直播 |
| 强项 | 漏斗、商机推进、服务工单、ToB 协作 | 私域沉淀、触达转化、导购赋能、裂变 |
| 数据特点 | 结构化单据与阶段状态 | 行为、会话、标签、触达频次 |
| 常见关系 | 客户与商机的「数据真源」 | 往往作为 CRM 的获客与运营前台 |

实践中常见三种落地方式：

1. **独立 SCRM + 同步到 CRM**：零售 / 本地生活更常见，SCRM 管加粉与触达，成交后回写 CRM
2. **CRM 内置社交模块**：传统 CRM 厂商补充企微、营销云能力
3. **中台统一客户 ID**：用会员 / CDP 打通 SCRM 行为数据与 CRM 交易数据

**学习要点：**

- SCRM 不是「多一个聊天工具」，关键是 **客户身份打通**（openId / unionId / 企微外部联系人 ↔ 会员 / CRM 客户）
- 合规与风控很重要：会话存档、营销频次、个人信息与同意机制
- 和电商中台、会员系统、导购 App 经常边界模糊，先画清「加粉—成交—履约」主链路再选型
...
| **零售 / 电商** | 中台 + WMS + TMS + CRM / SCRM + BI | 库存共享、履约时效、会员与私域运营 |
...
2. 再对照 CRM / SCRM / ERP / WMS / MES 各自卡在主链路的哪一段
...
| 容易混淆 | 区分要点 |
| --- | --- |
| CRM vs SCRM | CRM 偏客户档案与销售/服务过程；SCRM 偏社交获客、私域触达与社群运营 |
| CRM vs 客服工单 | CRM 覆盖营销销售全周期；工单只是服务环节之一 |
| SCRM vs 企微 / 社群工具 | 企微是触达通道；SCRM 是在通道之上做标签、SOP、转化与数据闭环 |
...
1. **SCRM 在社交与私域获客运营，CRM 沉淀客户与成交过程。**
2. **CRM 对外经营客户，ERP 对内经营资源与账。**
3. **MES / WMS 把计划变成现场动作，并回传实绩。**
4. **OA / BPM 让人按规则协作，BI 让数据支撑决策。**
